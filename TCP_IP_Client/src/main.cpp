...
static request_types services_menu()
{
...
void loop()
{
  ...
  if (authorized)
  {
    ...
    request_types choice = services_menu();
    build_request(message_details.session_Id, choice, tx_buffer);
  ...
  if (client.connected())
  {
    Serial.print("The whole message before sending is: ");
    print_data((uint8_t *)tx_buffer, tx_counter);
